import { k as getDefaultExportFromCjs$6, l as commonjsGlobal$1, m as process$1$5 } from "./index-DGtSCIDs.js";
var dist = {};
var hasRequiredDist;
...
function requireUtil() {
  ...
  (function(exports) {
    ...
    exports.deprecate = function(fn, msg) {
      if (typeof process$1$5 !== "undefined" && process$1$5.noDeprecation === true) {
        return fn;
      }
      if (typeof process$1$5 === "undefined") {
        return function() {
      ...
      function deprecated() {
        if (!warned) {
          if (process$1$5.throwDeprecation) {
            throw new Error(msg);
          } else if (process$1$5.traceDeprecation) {
            console.trace(msg);
          } else {
            console.error(msg);
          }
    ...
    var debugs = {};
    var debugEnvRegex = /^$/;
    if (process$1$5.env.NODE_DEBUG) {
      var debugEnv = process$1$5.env.NODE_DEBUG;
    ...
    function callbackify(original) {
      ...
      function callbackified() {
        ...
        original.apply(this, args).then(
          function(ret) {
            process$1$5.nextTick(cb.bind(null, null, ret));
          },
          function(rej) {
            process$1$5.nextTick(callbackifyOnRejected.bind(null, rej, cb));
          }
        );
      }
    ...
    if (readableDestroyed || writableDestroyed) {
      if (cb) {
        ...
        if (!this._writableState) {
          process$1$5.nextTick(emitErrorNT, this, err);
    ...
    this._destroy(err || null, function(err2) {
      if (!cb && err2) {
        if (!_this._writableState) {
          process$1$5.nextTick(emitErrorAndCloseNT, _this, err2);
        } else if (!_this._writableState.errorEmitted) {
          _this._writableState.errorEmitted = true;
          process$1$5.nextTick(emitErrorAndCloseNT, _this, err2);
        } else {
          process$1$5.nextTick(emitCloseNT, _this);
        }
      } else if (cb) {
        process$1$5.nextTick(emitCloseNT, _this);
        cb(err2);
...
function require_stream_writable() {
  ...
  function onwriteError(stream, state2, sync, er, cb) {
    ...
    if (sync) {
      process$1$5.nextTick(cb, er);
      process$1$5.nextTick(finishMaybe, stream, state2);
  ...
  function onwrite(stream, er) {
    ...
    if (er) onwriteError(stream, state2, sync, er, cb);
      ...
      if (sync) {
        process$1$5.nextTick(afterWrite, stream, state2, finished, cb);
      } else {
  ...
  function prefinish(stream, state2) {
    if (!state2.prefinished && !state2.finalCalled) {
      if (typeof stream._final === "function" && !state2.destroyed) {
        ...
        process$1$5.nextTick(callFinal, stream, state2);
      } else {
        state2.prefinished = true;
        stream.emit("prefinish");
      }
  ...
  function endWritable(stream, state2, cb) {
    ...
    finishMaybe(stream, state2);
    if (cb) {
      if (state2.finished) process$1$5.nextTick(cb);
...
function require_stream_duplex() {
  ...
  function onend() {
    ...
    process$1$5.nextTick(onEndNT, this);
  }
...
function requireAsync_iterator() {
  ...
  function onReadable(iter) {
    process$1$5.nextTick(readAndResolve, iter);
  }
...
function require_stream_readable() {
  ...
  function emitReadable(stream) {
    ...
    if (!state2.emittedReadable) {
      ...
      state2.emittedReadable = true;
      process$1$5.nextTick(emitReadable_, stream);
    }
  }
  ...
  function maybeReadMore(stream, state2) {
    if (!state2.readingMore) {
      ...
      process$1$5.nextTick(maybeReadMore_, stream, state2);
    }
  }
  ...
  Readable.prototype.pipe = function(dest, pipeOpts) {
    ...
    var doEnd = (!pipeOpts || pipeOpts.end !== false) && dest !== process$1$5.stdout && dest !== process$1$5.stderr;
    var endFn = doEnd ? onend : unpipe;
    if (state2.endEmitted) process$1$5.nextTick(endFn);
    ...
    if (ev === "data") {
      ...
      if (!state2.endEmitted && !state2.readableListening) {
        ...
        if (state2.length) {
          ...
          process$1$5.nextTick(nReadingNextTick, this);
        }
      }
    }
    return res;
  ...
  Readable.prototype.removeListener = function(ev, fn) {
    ...
    if (ev === "readable") {
      process$1$5.nextTick(updateReadableListening, this);
    }
    return res;
  };
  ...
  function resume(stream, state2) {
    if (!state2.resumeScheduled) {
      ...
      process$1$5.nextTick(resume_, stream, state2);
    }
  }
  ...
  function endReadable(stream) {
    ...
    if (!state2.endEmitted) {
      state2.ended = true;
      process$1$5.nextTick(endReadableNT, state2, stream);
    }
  }
...
const index = /* @__PURE__ */ getDefaultExportFromCjs$6(streamBrowserifyExports);
...
//# sourceMappingURL=standards-sdk.es52-C0GW91Ly.js.map
